...
export default function UCSBOrganizationCreatePage({ storybook = false }) {
  ...
  const onSuccess = (organization) => {
    toast(
      `New organization Created - code: ${organization.orgCode} short translation: ${organization.orgTranslationShort} translation: ${organization.orgTranslation} inactive: ${organization.inactive}`,
    );
  };
